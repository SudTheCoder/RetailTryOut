...
@date          20 July 2022
@description   ContactPointPhone Trigger
**********************************************************************************************/
trigger ContactPointPhoneTrigger on ContactPointPhone (before insert, after insert, before update,after update, before delete,after delete) {
     if((ASDAC_TriggerSetting__mdt.getInstance('Enable_New_Trigger_Framework').IsActive__c == true && !ASDAC_TriggerHandlerObj.enableOldTriggerFramework)
        ...
        ASDAC_TriggerFramworkService.triggerObj = ASDAC_GlobalConstants.OBJCONTACTPOINTPHONE;
        new ASDAC_ContactPointPhoneTriggerHandler().run();
    }else{
        ...
        trigObj.triggerObject = ASDAC_GlobalConstants.OBJCONTACTPOINTPHONE;
