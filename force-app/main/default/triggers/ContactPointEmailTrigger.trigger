/**********************************************************************************************
    ...
    @date          18 July 2022
    @description   ContactPointEmail Trigger
**********************************************************************************************/
trigger ContactPointEmailTrigger on ContactPointEmail (before insert,after insert,before update,after update,before delete) {
    if((ASDAC_TriggerSetting__mdt.getInstance('Enable_New_Trigger_Framework').IsActive__c == true && !ASDAC_TriggerHandlerObj.enableOldTriggerFramework)
        ...
        ASDAC_TriggerFramworkService.triggerObj = ASDAC_GlobalConstants.OBJCONTACTPOINTEMAIL;
        new ASDAC_ContactPointEmailTriggerHandler().run();
    }else{
        ...
        trigObj.triggerObject =ASDAC_GlobalConstants.OBJCONTACTPOINTEMAIL;
